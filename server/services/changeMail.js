...
class ChangeEmail {
	...
	constructor() {
		emitter.on('userUpdate', this.sendChangEmail);
	}
		...
		let mailOptions = {
			...
			html: 	'<html>\
						...
						<div style="text-align:center;font-size:20px;color:white;">\
							...
							<a style="color:white;" href=http://localhost:3000/changeEmail/?login='+ data.username +'&key='+ token +'>Confirm your Account</a>\
						</div>\
