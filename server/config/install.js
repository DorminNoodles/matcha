...
async function db() {
	try {
		...
		await connection.query(
			...
			VALUES ("David", "", "David", "TRAN", "tran.lili0.lili0@gmail.com", "male", "heterosexual", "Jai une seconde vie", 1, 22, 200, 18, 25, "Paris", 48.864716, 2.349014, "kneth_pls.jpg", NOW(), 17, 32),\
			("Lyana", "", "Lyana", "TRAN", "tran.lili1.lili@gmail.com", "female", "heterosexual", "je sais que je suis la", 1, 23, 200, 18, 25, "Saint-Denis", 48.56818, 2.62007, "kneth_pls.jpg", NOW(), 34, 16),\
			("Eric", "", "Eric", "TRAN", "tran.lili2.lili@gmail.com", "male", "homosexual", "Je suis juste Eric", 1, 20, 200, 18, 25, "Clichy", 48.904526, 2.304768, "kneth_pls.jpg", NOW(), 10, 8),\
			("Alix", "", "Alix", "TRAN", "tran.lili3.lili@gmail.com", "female", "homosexual", "la tapenade cest bon", 1, 20, 200, 18, 25, "Pontault-Combault", 48.801255,2.6075980000000527, "kneth_pls.jpg", NOW(), 5, 4),\
			("Kneth", "", "Kneth", "TRAN", "tran.lili4.lili@gmail.com", "male", "bisexual", "Si jetais dans Dragon Ball Z, Je serais Krillin: inutile", 1, 20, 200, 18, 25, "Marne-la-Vallee", 48.859276, 2.598504999999932, "kneth_pls.jpg", NOW(), 27, 2),\
			("Paloma", "", "Paloma", "TRAN", "tran.lili5.lili@gmail.com", "female", "bisexual", "Je suis du Perou", 1, 19, 200, 18, 25, "Poissy", 48.929584, 2.046982000000071, "kneth_pls.jpg", NOW(), 39, 1 ),\
			("Maxime", "", "Maxime", "TRAN", "tran.lili6.lili@gmail.com", "male", "bisexual", "peace and love", 1, 40, 200, 18, 25, "Andresy", 48.979048, 2.0510329999999612, "kneth_pls.jpg", NOW(), 27,2),\
			("Lisa", "", "Lisa", "TRAN", "tran.lili7.lili@gmail.com", "female", "heterosexual", "LOve PastEque", 1, 18, 200, 18, 25, "Charenton",  48.8193107, 2.4162804999999707, "kneth_pls.jpg", NOW(),34, 16),\
			("Pierre", "", "Pierre", "TRAN", "tran.lili8.lili@gmail.com", "male", "heterosexual", "J aime les meme", 1, 20, 200, 18, 25, "Paris", 48.8469373, 2.344468000000006, "kneth_pls.jpg", NOW(),17, 32 ),\
			("Marie", "", "Marie", "TRAN", "tran.lili9.lili@gmail.com", "female", "homosexual", "Je suis allergique", 1, 30, 200, 18, 25, "Paris", 48.8462217, 2.3371604999999818, "kneth_pls.jpg", NOW(),5, 4),\
			("Justine", "", "Justine", "TRAN", "tran.lili10.lili@gmail.com", "female", "bisexual", "Mes cuisses se dechirent", 1, 26, 200, 18, 25, "Paris", 48.8331048, 2.3268889999999374, "kneth_pls.jpg", NOW(), 39, 1);'
		);
