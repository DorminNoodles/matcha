...
export const NewPassword = ({ onChange, error, success, newPassword }) => (
    <React.Fragment>
        <Field placeholder="New Password" type="password" position="left" icon="fas fa-envelope" action={{ onChange: (e) => onChange(e, "value") }} />
        <Field placeholder="Confirmation" type="password" position="left" icon="fas fa-envelope" action={{ onChange: (e) => onChange(e, "confirm") }} error={error} success={success} />
