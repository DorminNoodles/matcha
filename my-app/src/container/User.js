...
class User extends React.Component {
  ...
  render() {
    ...
    return (
      <div id="user">
        <div id="info-user">
          <span style={{ display: "flex", fontWeight: "bold" }}>Lisa TRAN (
            <p style={{ fontStyle: "italic", fontWeight: 600 }}>Lisouiw</p>), 20</span>
          <br />
          ...
          <Tags />
          <Modal modal={this.state.modal} onChange={this.onChange} />
          <br />
