    ...
    <div id="user">
      <div style={{ flexWrap: "wrap", width: "100%", display: "flex", justifyContent: "center" }}>
        <div>
          ...
          <figure className="image is-128x128" style={{ margin: "10px 0px", textAlign: "center" }}>
